...
simulator = Portfolio(total_balance = 100000, underlying = None ,holding_list = ["VIXY","UVXY","SVXY"], indices = ["^VVIX"], data_start_date = "2016-01-01", sim_start_date = "2022-01-01" )
